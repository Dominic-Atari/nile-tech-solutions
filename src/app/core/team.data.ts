...
export const TEAM: readonly Worker[] = [
  {
    ...
    tagline: 'From Pathways graduate to software architect.',
    location: 'London, UK',
    initials: 'DO',
    accent: 'violet',
    bio: "Dominic went through Don't Panic Labs' 20-week Pathways Program and came out an engineer. He now leads architecture at Nile Tech — designing systems the IDesign way in C#, and building across Java, Angular, and Ionic.",
    ...
    history: [
      {
        ...
        description: 'Leads system architecture at Nile Tech — designing with the IDesign method in C#, and building across Java, TypeScript, Angular, and Ionic.',
        kind: 'milestone',
        current: true,
      },
      {
        ...
        description: 'Completed the 20-week Pathways Program — showed up, did the work, and walked out a thoughtful, capable software engineer ready to make a team better.',
        kind: 'education',
      },
      {
        year: '2025 – 2026',
        title: 'Making the switch into software',
        org: 'Self-directed',
        description: 'Committed to becoming an engineer — months of deliberate practice in the fundamentals that opened the door to Pathways.',
        kind: 'milestone',
      },
    ],
  },
